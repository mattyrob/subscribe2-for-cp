...
if ( $userid === $user_ID ) {
	echo '<h1>' . esc_html__( 'Your Notification Settings', 'subscribe2-for-cp' ) . "</h1>\r\n";
} else {
	echo '<h1>' . esc_html__( 'Notification Settings for user:', 'subscribe2-for-cp' ) . ' <span style="color: red;">' . esc_html( $user->display_name ) . '</span></h1>' . "\r\n";
}
...
// submit
echo '<p class="submit"><input type="submit" class="button-primary" name="submit" value="' . esc_attr__( 'Update Preferences', 'subscribe2-for-cp' ) . ' &raquo;" /></p>';
echo '</form>' . "\r\n";
